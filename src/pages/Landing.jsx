      ...
      <div class="landing-content">
        ...
        <Tabs defaultValue={1}>
          ...
          <TabPanel value={1}>
            ...
            numerous genres and traditions and on several instruments. Although
            he is primarily a pianist, he also performs on guitar, violin,
            viola, bayan, oud and various unusual string instruments. He is
            considered to be an expert in such diverse fields as pastiche
            composition, classical improvisation and score-reading. He is also a
            highly sought-after tutor in jazz and classical piano performance
            with his former students including a number of internationally known
            musicians and even number-one-selling artists. He also runs all the
            balkan brass ensembles in Scotland and is a highly-skilled
            guitarist. He is a graduate of the Royal Academy of Music, London.
          </TabPanel>
          <TabPanel value={2}>
          ...
          <TabPanel value={3}>
            ...
            orchestrator with abilities in pastiche composition of many eras and
            styles Multiple instrument/style session music performance with
            flawless reading, sight transposing, perfect pitch etc Wide
